...
/// <summary>纪念日完整故事页面。</summary>
public class DetailModel(IAnniversaryService anniversaries, SiteClock clock) : PageModel {
    /// <summary>获取当前纪念日。</summary>
    public AnniversaryOccurrence Item { get; private set; } = null!;

    /// <summary>获取当前排序中的上一篇纪念日。</summary>
    public AnniversaryOccurrence? Previous { get; private set; }

    /// <summary>获取当前排序中的下一篇纪念日。</summary>
    public AnniversaryOccurrence? Next { get; private set; }

    /// <summary>获取站点时区下的今天。</summary>
    public DateOnly Today => clock.Today;

    /// <summary>读取公开内容，或向已登录的情侣双方开放私密内容。</summary>
